...
export default ({
  ...
  description = "Once Registered You will be lifetime member.",
  plans = null,
  ...
  const defaultPlans = [
    {
      name: "Business Plan",
      durationPrices: ["₹30"],
      mainFeature: "For Business",
      features: ["Register Business", "Google Visiblity", "Searchable By location in Bspot App"]
    },
    {
      name: "Indivisual Plan",
      durationPrices: ["₹10"],
      mainFeature: "Suited for Indivisual",
      features: ["Visiblity on App",'Get Searched By Locals','Increase Reach'],
      featured: true
    }
  ];
